...
<div id="logo">
<a href="<?php echo gatorconf::get('base_url')?>"><img alt="filegator" src="<?php echo gatorconf::get('base_url')?>/include/views/img/logoS.gif"></a>
</div>
...
<div>
<p><span><?php echo lang::get("USER ID")?></span></p>
<input id="username" name="username" class="inputtext" type="text"></div>
<div>

<p><span><?php echo lang::get("ACCESS CODE")?></span></p>
...
<input class="nice radius button" type="Submit" name="submit" value="<?php echo lang::get("LOGIN")?>">
