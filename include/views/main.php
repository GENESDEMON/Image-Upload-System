...
<div id="logo">
<a href="<?php echo gatorconf::get('base_url')?>/?cd="><img alt="filegator" src="<?php echo gatorconf::get('base_url')?>/include/views/img/logos.gif"></a>
</div>
    ...
    <form id="fileupload" action="#" method="POST" enctype="multipart/form-data">
        ...
        <div class="nav fileupload-buttonbar">
                ...
                <span class="fileinput-button nice radius button">
					...
					<span class=""><?php echo lang::get("Add image.")?></span>
...
<div id="newfolder_button" class="navigation-button-right">
 ...
 <div class="nice radius button split dropdown navigation-button-right">
  <a class="new-folder"><?php echo lang::get("New Album")?></a>
  <span></span>
  <ul>
	<li><a class="new-folder"><?php echo lang::get("Create New Album")?></a></li>
...
<button type="button" class="nice secondary radius button zip-selected"><?php echo lang::get("Compress")?></button>
<?php endif;?>
